...
<div class="address-form__content">
  ...
  <form class="form" action="{{ route('purchase.address.update', $item_id) }}" method="post">
    @csrf
    <div class="form__group">
      ...
      <div class="form__group-content">
        <div class="form__input--text">
          <input type="text" name="postal_code" value="{{ old('postal_code', optional($user->profile)->postal_code) }}" >
        </div>
